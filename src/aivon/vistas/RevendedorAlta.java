    ...
    private void jb_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jb_guardarActionPerformed
        ...
        if (b<0) {
            if (JOptionPane.YES_NO_OPTION == JOptionPane.showConfirmDialog(this, "Estan correctos los datos", "Actualizar Revendedor", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE)) {
                ...
                //desactivarCampos();
                this.Limpiar();
                this.delay("Revendedor cargado con Exito", 6, 6);
                if(revendedor.getId_revendedor()==0){
                        jtf_aviso.setText("Ya existe ese revendedor");
                }
                
            } else {
                jtf_aviso.setText("Corrija los que desee o limpie");
                this.delay("", 9, 9);
            }
        } 
//        else {
//            jtf_aviso.setText("Debe ingresar los campos que faltan");
//        }
        this.delay("", 4, 4);
...
//######    Controla que sean 8 digitos   ######################################
    ...
    private void jtf_emailFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jtf_emailFocusLost
        ...
        if(Validacion.isValid(email)&& !(jtf_email.getForeground() == color)){
